...
class Board:
    ...
    # Returns the number of multipliers greater than 1
    def get_num_multipliers(self):
        return self.level_board[0] + self.level_board[1]

    # Returns the number of Voltorbs
    def get_num_voltorbs(self):
        return self.level_board[2]
